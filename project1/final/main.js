...
function drawImage() {
    ...
    let bodyX = xInput;
    let bodyY = yInput;
    // I chose the points where the tail meets the body; originally was going to pick roughly the center of the rooster body but since the xy coordinates were identical at 150, 150 I figured that would be boring. Now 125, 150. 
