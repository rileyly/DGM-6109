...
function makeDrawing (canvas, choice1, x1, y1, choice2, x2, y2, showOrigin) {
    ...
    if (choice1 == "rooster") {
        ...
        ladybug(item1, x1, y1, showOrigin);
    ...
    } else if (choice1 == "bulldog") { 
        dog(item1, x1, y1, showOrigin);
    } else if (choice1 == "trumpeter") { 
        trumpeter(item1, x1, y1, showOrigin);
    ...
    if (choice2 == "rooster") {
        ...
        ladybug(item2, x2, y2, showOrigin);
    ...
    }  else if (choice2 == "bulldog") {
        dog(item2, x2, y2, showOrigin);
    }  else if (choice2 == "trumpeter") {
        trumpeter(item2, x2, y2, showOrigin);
